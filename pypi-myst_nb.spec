...
Provides: myst-nb
Provides: myst-nb-python
Provides: myst-nb-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641457304
...
cp %{_builddir}/myst-nb-0.13.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-myst_nb/f6901900cf039247901977f1db5534db7b54141b
